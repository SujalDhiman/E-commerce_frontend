...
const Cart = () => {
    ...
    const getinddata = async () => {
        ...
        const res = await fetch(`https://backendecommerce.azurewebsites.net/getproductsone/${id}`, {
            method: "GET",
            headers: {
    ...
    const addtocart = async (id) => {
        console.log(id);
        const check = await fetch(`https://backendecommerce.azurewebsites.net/addcart/${id}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
