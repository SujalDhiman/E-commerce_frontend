...
const Navbaar = () => {
    ...
    {
        const data = await fetch("https://backendecommerce.azurewebsites.net/getproducts",{
                        method:"GET",
                        headers:{
   ...
   /* useEffect(() => {
    ...
    const logoutuser = async () => {
        const res2 = await fetch("https://backendecommerce.azurewebsites.net/logout", {
            method: "GET",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
    ...
    return (
        <header>
            <nav>
                ...
                <div className="right">
                    { loginState ?  ( <button className='logout_btn' onClick={()=>{
